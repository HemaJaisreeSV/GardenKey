...
import com.example.gardenkey.Model.Cart;
import com.example.gardenkey.Prevalent.Prevalent;
import com.example.gardenkey.ViewHolder.CartViewHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalPrice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                totalPrice.setText("Total Price = Rs." + String.valueOf(alloverTotalPrice));
            }
        });
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model)
            {
                ...
                holder.txtPrPrice.setText("Per Product = Rs." + model.getPrice());
        ...
        ordersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot)
            {
                if (snapshot.exists())
                {
                    ...
                    {
                        totalPrice.setText("Order Status = Not sent yet");
                        recyclerView.setVisibility(View.GONE);
