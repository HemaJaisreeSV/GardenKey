...
public class FloweringActivity extends AppCompatActivity {
    ...
    private RecyclerView categoryView_flowering;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoryView_flowering=(RecyclerView) findViewById(R.id.category_list_kids);
        categoryView_flowering.setLayoutManager(new LinearLayoutManager(FloweringActivity.this));
    }
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Products> options= new FirebaseRecyclerOptions.Builder<Products>()
                .setQuery(ProductsRef.orderByChild("category").equalTo("Flowers"), Products.class)
                .build();
                ...
                new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull final ProductViewHolder holder, int position, @NonNull final Products model)
                    {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            {
                                Intent intent = new Intent(FloweringActivity.this, ProductDetailsActivity.class);
        ...
        categoryView_flowering.setAdapter(adapter);
